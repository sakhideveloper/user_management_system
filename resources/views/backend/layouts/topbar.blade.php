<header id="page-topbar">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/new-small-logo.png') }}" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/new-small-logo.png') }}" alt="" height="30">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <a class="text-danger btn" style="font-size: 29px;margin-right: 24px;" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off  align-middle me-1 text-danger"></i> </a>
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
